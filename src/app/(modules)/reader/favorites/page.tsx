  ...
  return (
    <div className="shadow-2xl p-4 rounded-lg">
      ...
      <div className="flex flex-wrap justify-between mb-5">
        <h1 className="font-custom relative text-2xl m-0 text-primary-500 font-bold before:content-[''] before:block before:absolute before:h-full before:w-1 before:bg-primary-500 before:left-0">
