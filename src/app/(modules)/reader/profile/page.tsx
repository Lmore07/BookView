...
export default function ProfileReader() {
  ...
  useEffect(() => {
    ...
    addBreadcrumbManyItems([HomeBreadCrumb, profileBreadCrumb]);
    ...
    <div className="shadow-2xl p-4 rounded-lg">
      ...
      <div className="flex flex-wrap justify-between mb-5">
        <h1 className="font-custom m-0 relative text-2xl text-primary-500 font-bold lg:before:content-[''] lg:before:block md:before:absolute lg:before:absolute xl:before:absolute before:h-full before:w-1 before:bg-primary-500 before:left-0">
          <span className="xl:ps-2 lg:ps-2 md:ps-2">Editar perfil</span>
        </h1>
      </div>
      <div className="grid grid-cols-1 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 gap-4">
        <div className="flex flex-col w-full">
          ...
          <div className="gap-5">
            <div className="bg-bgInputText rounded-md h-64 w-full flex items-center justify-center hover:text-secondary-400 hover:border hover:border-black">
