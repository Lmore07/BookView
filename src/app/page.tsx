    ...
    <div className="flex flex-col min-h-[100dvh] font-custom">
          ...
          <div className="container grid gap-12 px-4 md:px-6 relative z-10">
            <div className="flex flex-col items-center justify-center space-y-4 text-center animate-fadeIn">
              <div className="space-y-2 flex flex-col items-center">
                <div className="inline-block font-semibold rounded-lg text-titleLanding bg-gradient-to-r from-primary-250 to-secondary-250 px-3 py-1 text-sm  ">
                  Creación y lectura de libros
                </div>
                <h2 className="text-3xl text-titleLanding font-bold tracking-tighter sm:text-5xl animate-slideInDown dark:text-black">
            ...
            <div className="mx-auto grid max-w-5xl divide-y shadow-xl divide-border rounded-lg border border-gray-200 md:grid-cols-3 md:divide-x md:divide-y-0 dark:border-gray-800 animate-slideInUp">
              <div className="flex items-center flex-col gap-4 p-8 md:p-10 hover:bg-gradient-to-r from-primary-100 to-secondary-200  transition-colors duration-300 ease-in-out">
                ...
                <div className="text-xl font-bold text-titleLanding">Interfaz intuitiva</div>
              ...
              <div className="flex items-center flex-col gap-4 p-8 md:p-10 hover:bg-gradient-to-r from-primary-100 to-secondary-200 transition-colors duration-300 ease-in-out">
                ...
                <div className="text-xl font-bold text-titleLanding">Integración multimedia</div>
                <div className="text-textLanding dark:text-gray-400">
              ...
              <div className="flex items-center flex-col gap-4 p-8 md:p-10 hover:bg-gradient-to-r from-primary-100 to-secondary-200 transition-colors duration-300 ease-in-out">
                ...
                <div className="text-xl font-bold text-center text-titleLanding">
        ...
        >
          <div className="container flex items-center justify-center gap-4 px-4 md:px-6">
            <div className="space-y-3 animate-fadeIn flex flex-col items-center">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-titleLanding animate-slideInDown">
                Experimente el poder del diseño universal
              </h2>
              <div className="mx-auto max-w-[700px] text-textLanding md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed animate-fadeIn">
          ...
          <div className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
            <div className="space-y-2 animate-fadeIn flex flex-col justify-center">
              ...
              <div className="max-w-[600px] text-textLanding md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed text-left inline-block dark:text-gray-400 animate-fadeIn">
                ...
                principios del Diseño Universal para el Aprendizaje (DUA). El
                DUA es un marco que guía el diseño de experiencias de
                aprendizaje para que sean accesibles y efectivas para todas las
                personas, independientemente de sus habilidades, antecedentes o
      ...
      <footer className="flex font-custom gap-2 sm:flex-row w-full items-center border-t bg-gradient-to-r from-primary-100 to-secondary-100 shadow-lg">
        <div className="container px-4 mx-auto">
          <div className="lg:flex pt-2">
            <div className="w-full -mx-6 lg:w-2/5">
              <div className="px-6">
                <div className="flex gap-4">
                  ...
                  <p className="max-w-sm m-0 mt-2 text-textLanding">
                ...
                <div className="flex mt-6 -mx-2">
                  <Link
                    href="https://www.facebook.com/uteq.ecuador/"
                    target="_blank"
                  ...
                  <Link
                    href="https://www.youtube.com/user/UTEQCHANNEL/videos"
                    target="_blank"
                    className="mx-2 text-textLanding transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400"
                    aria-label="Facebook"
                  >
                  ...
                  <Link
                    href="https://ec.linkedin.com/school/universidad-t%C3%A9cnica-estatal-de-quevedo/"
                    target="_blank"
                    className="mx-2 text-textLanding transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400"
                    aria-label="LinkedIn"
                  >
                  ...
                  <Link
                    href={"https://www.tiktok.com/@uteq.ec"}
                    target="_blank"
                    className="mx-2 text-textLanding transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400"
                    aria-label="TikTok"
                  >
            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                <div>
                  <h3 className="text-textLanding font-semibold m-0 uppercase dark:text-white">
                    Servicios
                  </h3>
                  <a
                    href="https://biblioteca.uteq.edu.ec/"
                    target="_blank"
                    className="block mt-2 text-sm text-textLanding hover:underline"
                  >
                    Biblioteca
                  </a>
                  <a
                    href="https://elibro.net/es/lc/uteq/login_usuario/?next=/es/lc/uteq/inicio"
                    target="_blank"
                    className="block mt-2 text-sm text-textLanding hover:underline"
                  >
                    E-Libro
                ...
                <div>
                  ...
                  <span className="block mt-2 text-sm text-textLanding hover:underline">
          ...
          <div>
            <p className="text-center text-textLanding">
