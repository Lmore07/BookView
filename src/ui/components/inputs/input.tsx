...
const Input = ({
  ...
  return (
    <div className={`input-component ${className}`}>
      {label && (
        <div className="font-open-sans text-sm font-bold text-labelInputText pb-1">
          {label}
        </div>
      )}
      <div className="relative">
        <input
          ...
          className={`w-full font-open-sans bg-bgInputText px-3 py-2 border-0 text-sm font-normal hover:placeholder:text-secondary-400 text-secondary-400 rounded-md outline-none hover:text-secondary-400 hover:border hover:border-black ${
