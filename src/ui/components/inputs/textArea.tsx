    ...
    <div className={`input-component ${className}`}>
      ...
      <div className="relative flex items-center">
        <textarea
          ...
          name={name}
          rows={rows ?? 10}
          className={`w-full pl-9 pr-14 font-custom bg-bgInputText px-3 py-2 border-0 text-sm font-normal placeholder:text-gray-500 hover:placeholder:text-secondary-400 text-secondary-400 rounded-md outline-none hover:text-secondary-400 hover:border hover:border-black ${
