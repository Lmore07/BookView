        ...
        <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
          <div className="overflow-hidden border-b border-gray-200 shadow sm:rounded-lg">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-bgHeaderTable">
                <tr>
                  {headers.map((header, index) => (
                    <th
                      key={header.key}
                      scope="col"
                      className="px-6 py-3 text-xs font-normal tracking-wider text-left text-textHeaderTable uppercase font-custom"
                    >
                      {header.name}
                    </th>
                  ))}
              ...
              <tbody className="bg-bgRowsTable divide-y divide-gray-200">
                {data.map((item, index) => (
                  <tr key={index}>
                    {headers.map((header, index) => (
                      <td
                        key={index}
                        className="px-6 py-4 whitespace-nowrap text-sm text-textRowsTable"
                      >
                        {header.key === "status" ? (
                          <span>
